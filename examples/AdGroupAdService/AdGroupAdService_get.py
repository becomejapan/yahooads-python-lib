      ...
      }, 
      {
        ...
        "adGroupAd": {
          ...
          "ad": {
            "xsi_type": "TextAd2", 
            "type": "TEXT_AD2", 
            "advancedUrl": "http://yahoo.co.jp/sample/url", 
            "additionalAdvancedUrls": [
              {
                "advancedUrl": "http://yahoo.co.jp/sample/url1"
              }, 
              {
                "advancedUrl": "http://yahoo.co.jp/sample/url2"
              }, 
              {
                "advancedUrl": "http://yahoo.co.jp/sample/url3"
              }
            ], 
            "advancedMobileUrl": "http://yahoo.co.jp/sample/mobile/url", 
            "additionalAdvancedMobileUrls": [
              {
                "advancedMobileUrl": "http://yahoo.co.jp/sample/mobile/url1"
              }, 
              {
                "advancedMobileUrl": "http://yahoo.co.jp/sample/mobile/url2"
              }
            ], 
            "trackingUrl": "http://yahoo.co.jp?url={lpurl}&c={campaignid}&g={adgroupid}&a={creative}&type={site}&pid={id1}&vid={id2}", 
            "customParameters": {
